  ...
  return (
    <>
      <Element name="courses">
        <div className="h-[1400px] md:h-[900px] m-1 bg-[rgb(221,206,184)]">
          <h2 className="text-4xl font-bold pt-10 text-center">
            Courses We Offer
          </h2>

          <section className="h-full w-full md:h-[90%] m-1 p-5 flex flex-col items-center justify-evenly md:w-[42%] md:grid md:gap-3 md:grid-col-2 md:grid-row-2 mx-auto">
            <Card
              isBlurred
